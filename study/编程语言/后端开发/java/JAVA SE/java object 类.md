...
官方文档地址：https://docs.oracle.com/javase/7/docs/api/java/lang/Object.html
...
1. 说明输出结果。
    ...
    解析：
    	super.getClass()调用的是父类Date的方法，该方法继承自Object类。
    	public final Class<?> getClass()//该方法不能被修改
    	说明：返回的是当前运行的类。即SuperTest
